<form method="post" class="validate ajax-submit" id="form-create-appointment" autocomplete="off" action="{{ route('appointments.store') }}" enctype="multipart/form-data">
	@csrf
	<div class="col-md-12">
	  ...
	  <div class="col-md-12">
		<div class="form-group">
		  ...
		  <select class="form-control" name="user_id" id="doctor-select-modal" required>
	  ...
	  <div class="col-md-12">
		<div class="form-group">
		  ...
		  <select class="form-control" name="appointment-status" id="appointment-status-select-modal" required>
			  <option value="" disabled selected>Selecione o médico</option>
...
const doctorId = $('#doctor-select-modal').val();
